...
export default  function ProductDetails() {
    ...
    useEffect(() => {   dispatch(fetchProductById(location.state.productId))}, [dispatch])
     let product = useSelector(  (state) =>  state.products.data)
     async function x (){ return await product}
     let [prod, setprod]=useState()
     x().then(((v)=>{ setprod(v)}))
     try{
        console.log(prod.categoryId.name_en)
     }catch{}
     function c(){try{return 5}catch{}}
    return (
        <>
            <div className='row justify-content-center '>
                ...
                <div className="col-lg-4  col-md-4 col-sm-6 p-4  " >
                    ...
                    <NavLink to="/" style={{ textDecoration: "none", color: "rgb(0,113,165)" }}><p>catigory : {c()}</p></NavLink>
