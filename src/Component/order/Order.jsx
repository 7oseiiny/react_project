        ...
        <div className="col-lg-9 col-sm-12 col-md-12 p-4 order-left-width" >
          ...
          <div>
            ...
            <div className='border border-2 p-2' style={{ borderRadius: "8px" }}>
              ...
              <label className='d-flex align-items-center p-2 border border-2 my-2' style={{ borderRadius: "8px" }}>
                <input type="radio" value="Male" name="payment" />
        ...
        <div className='col-lg-3 col-md-12 px-4 col-sm-12' >
          <div className=" h-100  border border-2 my-2 p-3  " style={{ borderRadius: "8px", position: "sticky", top: "50px" }}>
            ...
            <div className='d-flex justify-content-between'>
              ...
              <p style={{ fontSize: ".8rem", padding: "5px" }} className='m-0 p-0'>2.125 EGP</p>
            </div>
            <div className='d-flex justify-content-between'>
            ...
            <div className='d-flex justify-content-between'>
              <p style={{ fontSize: ".8rem", padding: "5px" }} className='m-0 p-0'>Promotion applied:	:</p>
              <p style={{ fontSize: ".8rem", padding: "5px" }} className='m-0 p-0'>2.125 EGP</p>
            </div>
            <hr />
            <div className='d-flex justify-content-between'>
              ...
              <h5 style={{ color: "rgb(177,39,60)" }} >25855 EGP</h5>
            </div>
            <hr />
