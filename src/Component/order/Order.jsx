    ...
    <>
      <PayPalScriptProvider options={initialOptions}>
        <div className="p-2  d-flex justify-content-between align-items-center" style={{ backgroundColor: "rgb(244,244,244)" }}>
          <div>
            <img className="p-2 m-0" src="public\assets\orderimage\amazon-logo-free-png.png" style={{ width: "150px" }} alt="" />
          </div>
        ...
        <div className="row p-3 ">
              ...
              <div className="border border-2 p-2" style={{ borderRadius: "8px" }}>
                ...
                <label className="w-100  align-items-center p-2 border border-2 my-2" style={{ borderRadius: "8px" }}>
                  ...
                  <div>
                    <p className="px-4">
                      {" "}
                      Pay by cash on delivery. Non-refundable COD fees of EGP 12 may apply. Learn more. Pay online for contactless deliveries.
                    </p>
                  </div>
                </label>
              </div>
          ...
          <div className="col-lg-3 col-md-12 px-4 col-sm-12">
            <div className=" h-100  border border-2 my-2 p-3  " style={{ borderRadius: "8px", position: "sticky", top: "50px" }}>
              <button disabled={cart.length == 0} onClick={usemethod} className="btn btn-warning w-100" style={{ fontSize: "1rem" }}>
                use this payment method{" "}
              </button>
              <p style={{ fontSize: ".8rem", textAlign: "center", padding: "5px" }}>
              ...
              <div className="d-flex justify-content-between">
                <p style={{ fontSize: ".8rem", padding: "5px" }} className="m-0 p-0">
                  items:
                </p>
                <p style={{ fontSize: ".8rem", padding: "5px" }} className="m-0 p-0">
