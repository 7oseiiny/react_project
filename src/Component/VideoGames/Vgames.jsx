            ...
            <Row>
              ...
              <div className="card mt-4">
                <div className="card-body">
                  <span>
                    {t("1-12 of over 70,000 results for")} <span className="text-danger fw-bold">{t("VideoGames")}</span>
                  </span>
                </div>
              </div>
                        ...
                        <div className="card-body">
                          ...
                          <div className="d-flex">
                            ...
                            <span className="pt-3 me-2">
                              List: <span className="text-muted pt-3 text-decoration-line-through me-2"> EGP{prod.price.old}.00</span>
                            </span>
                          </div>
                          <div className="d-flex align-items-start me-3">
                            <img src="../assets/images/a.PNG" style={{ width: "50px" }} />
                            <span>
                              Get it as soon as<span className="fw-bold"> Saturday, September 9</span>
                            </span>
                          </div>
