        ...
        <div className="col-xl-10 col-md-9 col-8 sideRight container-fluid justify-content-center align-content-center">
          <div className="container-fluid">
            <div className="row">
              ...
              <img src={language == "en" ? "../assets/images/XCM_.jpg" : "../assets/images/fashionArabicImag.jpg"} className="img-fluid" alt="..." />
              <div className="container-fluid my-2 joinPrime" id="joinPrime">
                <div className="row col-12 d-flex flex-md-row flex-column justify-content-center p-2">
                  <p className="col-md-5 me-2 fs-5">{t("Enjoy FREE delivery, exclusive deals, award-winning TV and more Join today")}</p>
                ...
                <div className="row row-cols-2 row-cols-md-3 row-cols-lg-6 g-3">
                  <div className="col">
                    <div className="card border-0">
                      ...
                      <div className="card-body">
                        <h6 className="card-text text-center">{t("Mobiles& Accessories")}</h6>
                      </div>
                    </div>
                  </div>
                  <div className="col">
                  ...
                  <div className="col">
                    <div className="card border-0">
                      ...
                      <div className="card-body">
                        <h5 className="card-text text-center">{t("PCs & accessories")}</h5>
                      </div>
                    </div>
                  </div>
                  <div className="col">
          ...
          <div>
           ...
           <BsStarHalf color='#FFA41C'/>(2,494)
              ...
              <div className="card mt-4">
                <div className="card-body">
                  <span>
                    {t("1-12 of over 70,000 results for")} <span className="text-danger fw-bold">{t("Electronics")}</span>
                  </span>
                </div>
              </div>
            </div>
